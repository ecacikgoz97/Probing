...
args.device = device
args.mname  = 'MiniGPT_3_500epochs_lr0001_scheduler' 
...
# training
args.batchsize = 128; args.epochs = 700
...
args.trndata = working_path + 'NLP/Probing/polarity/data/polar.uniquesurfs.trn.txt' 
args.valdata = working_path + 'NLP/Probing/polarity/data/polar.uniquesurfs.val.txt'
args.tstdata = working_path + 'NLP/Probing/polarity/data/polar.uniquesurfs.val.txt' 
...
print(args.model)
# logging
args.modelname = working_path + 'NLP/Probing/polarity/results/'+args.mname+'/'+str(len(trndata))+'_instances/'
try:
