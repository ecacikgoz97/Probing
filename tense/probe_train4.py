# -----------------------------------------------------------
# Date:        2022/02/17 
# Author:      Muge Kural & Emre Can Acikgoz
...
args.device = device
args.mname = 'MiniGPT_500epochs_lr001_batch32_scheduler'
...
args.trndata = working_path + 'NLP/Probing/tense/data/tense.uniquesurfs.trn.txt' 
args.valdata = working_path + 'NLP/Probing/tense/data/tense.uniquesurfs.val.txt'
args.tstdata = working_path + 'NLP/Probing/tense/data/tense.uniquesurfs.val.txt' 
...
# logging
args.modelname = working_path + 'NLP/Probing/tense/results/training/'+args.mname+'/'+str(len(trndata))+'_instances/'
